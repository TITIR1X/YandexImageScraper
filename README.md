...
## You need to replace the path "C:\UsersApplicationData" in the script with the path on your PC, follow these steps:

   1- Open Windows File Explorer. You can do this by clicking on the folder icon in the Windows Start menu or by pressing the Windows key + E.

   2- In the File Explorer address bar, type the following text: %localappdata% and press Enter. This will take you to the "AppData" folder in your user's local data folder in Windows.

   3- Inside the "Local" folder, find the "Google" folder and click on it to open it.

   4- Inside the "Google" folder, find the "Chrome" folder and click on it to open it.

   5- Inside the "Chrome" folder, find the "User Data" folder and click on it to open it.

   6- The "User Data" folder is the folder you were looking for - congratulations, you've found it! Now replace the path in the .py files.
